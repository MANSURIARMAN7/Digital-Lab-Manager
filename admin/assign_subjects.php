...
<head>
    ...
    <style>
        ...
        .form-control, .form-select { padding: 10px 15px; background: #f8fafc; border: 1px solid #cbd5e1; font-weight: 500; border-left: none; }
        .form-control:focus, .form-select:focus { border-color: #2563eb; box-shadow: none; background: #fff; }
        .input-group:focus-within .input-group-text { border-color: #2563eb; color: #2563eb; background: #fff; }
            ...
            <form method="POST" id="assignForm">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text rounded-start-2"><i class="fa-solid fa-user-tie"></i></span>
                        <select name="faculty_id" class="form-select rounded-end-2" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text rounded-start-2"><i class="fa-solid fa-building-columns"></i></span>
                        <select name="branch" class="form-select rounded-end-2" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text rounded-start-2"><i class="fa-solid fa-calendar-days"></i></span>
                        <select name="semester" class="form-select rounded-end-2" required>
